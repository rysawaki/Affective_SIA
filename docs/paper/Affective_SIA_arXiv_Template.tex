...
\begin{figure}[H]
    ...
    \caption{Sensitivity Analysis (N=10 trials). Error bars indicate standard deviation. Agents with higher sensitivity ($\alpha$) form significantly stronger identities, though with increased variance, suggesting a high-risk, high-reward dynamic.}
